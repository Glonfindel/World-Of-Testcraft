...
public class AccountRepositoryImpl implements AccountRepository {
    ...
    public int add(Account account) {
        ...
        try {
            ...
            ResultSet generatedKeys = addAccountStmt.getGeneratedKeys();
    ...
    public void setConnection(Connection connection) throws SQLException {
        this.connection = connection;
        addAccountStmt = connection.prepareStatement("INSERT INTO Account (login, password) VALUES (?, ?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public void initDatabase() throws SQLException {
        connection.createStatement()
                .executeUpdate("CREATE TABLE " + "Account(id bigint GENERATED BY DEFAULT AS IDENTITY, "
                        + "login varchar(32) NOT NULL, " + " password varchar(32) NOT NULL,PRIMARY KEY (id))");
    }
